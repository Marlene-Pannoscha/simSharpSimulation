namespace simSharpSimulation
{
    ...
    internal sealed class PatientenKonfiguration : PersonenKonfiguration
    {
        ...
        public static (PatientenTyp Typ, double Wahrscheinlichkeit, double BehandlungszeitArzt, double BehandlungszeitSchwester)[] TYPEN_VERTEILUNG { get; internal set; } = new[]
        {
            (PatientenTyp.Kurz, 0.3, 3.0, 2.0),
            (PatientenTyp.Mittel, 0.6, 7.0, 5.0),
            (PatientenTyp.Lang, 0.1, 15.0, 10.0)
        };
